...
public class Map implements GameConstants{
     ...
     */
    private int countLeft(MapTile t, int xPosInArray, int yPosInArray, Enemy enemy, Player player) {
        int count = 0;
     ...
     */
    private int countRight(MapTile t, int xPosInArray, int yPosInArray, Enemy enemy, Player player) {
        int count = 0;
     ...
     */
    private int countUp(MapTile t, int xPosInArray, int yPosInArray, Enemy enemy, Player player) {
        int count = 0;
        boolean endCount = false;
        while(endCount == false) {
            if ((enemy.checkCollidedWith(t.getRect())) || (player.checkPlayerWallCollision(t.getRect()))) {
     ...
     */
    private int countDown(MapTile t, int xPosInArray, int yPosInArray, Enemy enemy, Player player) {
        int count = 0;
        boolean endCount = false;
        while (endCount == false) {
            if ((enemy.checkCollidedWith(t.getRect())) || (player.checkPlayerWallCollision(t.getRect()))) {
     ...
     */
    private void processMapLine(int row, String line) {
